...
//vector<double> getMetricFromFile(const char*, int offset, int col, int lines);
...
public:
	...
	Load(){
		...
		cpu_loads = getMetricFromFile("iolog.txt",1,1,3);
		...
		tps_parts = getMetricFromFile("iolog.txt",13,2,-1);
